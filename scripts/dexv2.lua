...
NewGuiPart157.Name = "_SelectionChanged"
...
local _SelectionChanged = ExplorerPanel:WaitForChild("_SelectionChanged")
...
_SelectionChanged.Event:connect(function()
...
- 2013-09-11
	...
	- Ensured _SelectionChanged fires only when the selection actually changes.
...
- 2013-09-09
	...
	- Removed "Selection" ObjectValue.
		...
		- Added _SelectionChanged BindableEvent.
...
local Selection do
	...
	local bind_SelectionChanged = explorerPanel:FindFirstChild("_SelectionChanged")
	if not bind_SelectionChanged then
		bind_SelectionChanged = Create('BindableEvent',{Name = "_SelectionChanged"})
		bind_SelectionChanged.Parent = explorerPanel
	end
...
local bind_SelectionChanged = ExplorerFrame._SelectionChanged
...
bind_SelectionChanged.Event:connect(function()
	showProperties(GetSelection())
end)
